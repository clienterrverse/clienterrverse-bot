...
/**
 * @typedef {Object} ClaimTicketButton
 * @property {string} customId - The custom ID of the button.
 * @property {Array} userPermissions - The permissions required for the user to interact with the button.
 * @property {Array} botPermissions - The permissions required for the bot to interact with the button.
 * @property {Function} run - The function that runs when the button is interacted with.
 */

/**
 * @type {ClaimTicketButton}
 */
const claimTicketButton = {
  ...
  /**
   * The function that runs when the button is interacted with.
   * @param {Client} client - The Discord client.
   * @param {Interaction} interaction - The interaction that triggered the button.
   */
