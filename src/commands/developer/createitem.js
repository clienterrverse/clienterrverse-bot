...
export default {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const category =
        interaction.options.getString('category') || 'Miscellaneous';
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `Item '${name}' has been created with ID '${itemId}', priced at ${price} clienterr coins.`
        )
        .addFields(
